...
- Version: `1.9.1`
- Release: `https://github.com/SNIX-MED/GAWELA-Tourenplaner/releases/tag/v1.9.1`
...
- Die Update-Quelle zeigt auf `releases/latest/download/...` und liefert aktuell `1.9.1.0`.

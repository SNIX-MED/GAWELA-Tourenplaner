...
- Version: `1.0.8`
- Release: `https://github.com/SNIX-MED/GAWELA-Tourenplaner/releases/tag/v1.0.8`
...
- Die Update-Quelle zeigt auf `releases/latest/download/...` und liefert aktuell `1.0.8.0`.

...
- Version: `1.0.2`
- Release: `https://github.com/SNIX-MED/GAWELA-Tourenplaner/releases/tag/v1.0.2`
...
- Die Update-Quelle zeigt auf `releases/latest/download/...` und liefert aktuell `1.0.2.0`.
